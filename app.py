...
def handle_text(reply_token, user_id, text):
    ...
    # ยี่ห้อแผง
    if any(w in text_lower for w in ["ยี่ห้อ","แผงอะไร","inverter","หัวเว่ย","longi","jinko"]):
        reply_message(reply_token, [{"type":"text","text":"ใช้ของดีครับ Tier1 ระดับโลก\n\n🔋 แผง: Longi Hi-MO 6 / Jinko Tiger Neo 550W ประสิทธิภาพสูง\n🔌 อินเวอร์เตอร์: Huawei / Growatt มีแอปดูในมือถือ\n🔩 รางและสายไฟ ได้มาตรฐาน\n\nไม่ใช้ของถูกแล้วมีปัญหาครับ\n\nบิลคุณเท่าไหร่ครับ? เดี๋ยวผมจัดสเปคที่เหมาะกับบ้านคุณให้ดูครับ"}])
        return
